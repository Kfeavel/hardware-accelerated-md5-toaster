...
#endif
# 166 "md5.cu"
void md5_cuda_calculate(void *memory, device_stats *stats, unsigned *
# 167
debug_memory) ;
#if 0
# 167
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__11_md5_cpp1_ii_b3617efc
# 1 "md5.cudafe1.stub.c"
